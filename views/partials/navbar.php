...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
        <a class="navbar-brand text-uppercase d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <?php if (isset($_SESSION['nama'])) : ?>
                    <div class="dropdown">
                        <button class=" btn btn-light dropdown-toggle nav-item" type="button" data-bs-toggle="dropdown" aria-expanded="false">INFORMASI
                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item text-capitalize" href="/alumni">Alumni</a></li>
                            <li><a class="dropdown-item text-capitalize" href="/cetak-kartu/<?= $_SESSION['user_id'] ?>">Cetak
                                    Kartu</a></li>
                        </ul>
                    </div>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <form>
                                <li><a class="dropdown-item text-capitalize" href="logout.php" onclick="return confirm('Kamu yakin menghapus quote ini?')">Logout</a></li>
                            </form>
                        </ul>
                    </div>
